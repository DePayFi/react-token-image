(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@depay/web3-blockchains'), require('@depay/web3-constants'), require('@depay/web3-client-evm')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@depay/web3-blockchains', '@depay/web3-constants', '@depay/web3-client-evm'], factory) :
...
}(this, (function (exports, React, web3Blockchains, web3Constants, web3ClientEvm) { 'use strict';
  ...
  let TokenImage = function(props){
    ...
    const handleLoadError = (error)=> {
      if(source == 'repository') {
        ...
        web3ClientEvm.request({ blockchain, address, api: tokenURIAPI, method: 'tokenURI', params: [0] }).then(async(tokenURI)=>{
